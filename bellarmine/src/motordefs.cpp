...
int Ports::LEFT_MTR_F_PORT = 15;
int Ports::RIGHT_MTR_B_PORT = 20;
int Ports::RIGHT_MTR_F_PORT = 16;
int Ports::TILT_MTR_PORT = 4;
int Ports::LEFT_INTAKE_MTR_PORT = 2;
int Ports::RIGHT_INTAKE_MTR_PORT = 6;
int Ports::LIFT_MTR_PORT = 8;
...
MotorDefs::MotorDefs() {
    ...
    tilt_mtr = new pros::Motor(Ports::TILT_MTR_PORT, pros::E_MOTOR_GEARSET_36, true);
    ...
    lift_mtr = new pros::Motor(Ports::LIFT_MTR_PORT, pros::E_MOTOR_GEARSET_36, true);
}
