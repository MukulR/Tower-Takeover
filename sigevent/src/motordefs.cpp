...
MotorDefs::MotorDefs() {
    left_mtr_f = new pros::Motor(Ports::LEFT_MTR_F_PORT, pros::E_MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_DEGREES);
    right_mtr_f = new pros::Motor(Ports::RIGHT_MTR_F_PORT, pros::E_MOTOR_GEARSET_18, true, pros::E_MOTOR_ENCODER_DEGREES);
    left_mtr_b = new pros::Motor(Ports::LEFT_MTR_B_PORT, pros::E_MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_DEGREES);
    right_mtr_b = new pros::Motor(Ports::RIGHT_MTR_B_PORT, pros::E_MOTOR_GEARSET_18, true, pros::E_MOTOR_ENCODER_DEGREES);
